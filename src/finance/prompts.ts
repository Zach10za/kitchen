...
- **cash_flow**: monthly inflows vs outflows with inter-account transfers excluded (anything categorized "Transfer"). Mirrors the live Cash Flow tab + chart in the sheet. If a transfer is being counted, categorize that row "Transfer" (or set a rule) and it drops out — the sheet's formulas update instantly.
